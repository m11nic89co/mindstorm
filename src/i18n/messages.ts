...
export const messagesRu: Messages = {
  toolbar: {
    ...
    save: 'Сохранить как',
    saveTitle: 'Сохранить как: выбрать имя, .mindstorm + PNG в png/',
    load: 'Загрузить',
...
export const messagesEn: Messages = {
  toolbar: {
    ...
    addGroupShort: '◻ Group',
    save: 'Save as',
    saveTitle: 'Save as: pick a name, .mindstorm + PNG into png/',
    load: 'Open',
...
export const messagesEs: Messages = {
  toolbar: {
    ...
    addGroupShort: '◻ Grupo',
    save: 'Guardar como',
    saveTitle: 'Guardar como: elegir nombre, .mindstorm + PNG en png/',
    load: 'Abrir',
...
export const messagesZh: Messages = {
  toolbar: {
    ...
    addGroupShort: '◻ 分组',
    save: '另存为',
    saveTitle: '另存为：选择名称，.mindstorm + PNG 到 png/',
    load: '打开',
