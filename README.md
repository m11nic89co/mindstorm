...
- **Печать** — вся схема или выделенный фрагмент; A4 альбом, по центру, масштаб 50%, без мини-карты
...
3. **T Текст** — простой текст в любом месте (цвет и размер справа)
...
10. **Сохранить** / **Загрузить** — файл на компьютер
11. **🖨** (рядом с темой) — печать: вся схема или выделенное; A4 альбом, 50%, по центру
12. **☀ / ☾** — светлая или тёмная тема
13. **Сначала** — новая пустая схема; **↺ Демо** — пример
14. **RU | EN | ES | 中** — язык интерфейса
15. **Delete** — удалить выделенное
16. **Колёсико** — zoom (сильное отдаление для больших схем)
