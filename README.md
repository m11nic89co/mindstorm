...
- **Resize группы** — карточки и вложенные группы внутри (по центру в рамке) масштабируются пропорционально
...
6. **Угол группы** — растянуть рамку; карточки внутри масштабируются вместе с ней
